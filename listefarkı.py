...
# Aşağıda bulunan listeleri birbirleriyle karşılaştırın ve birinci listede bulunan 
#hangi sayıların ikinci listede olmadığını, ikinci listede bulunan hangi sayıların birinci listede olmadığını tespit edin.
