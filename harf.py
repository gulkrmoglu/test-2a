...
# Kullanıcıya uzun bir metin gösterin daha sonra kullanıcıdan hangi harften kaç 
# tane geçtiğini öğrenmek istediğini sorun. Daha sonra kullanıcının talep ettiği 
# harfin metinde kaç defa geçtiğini tespit edin.
...
harf=input("Lütfen sayısını istediğiniz harfi girin: ")
harf_sayisi=0
for i in metin:
    if (i==harf):
        harf_sayisi+=1
print(harf,"harf metinde şu kadar sayıda geçmektedir:", harf_sayisi)
